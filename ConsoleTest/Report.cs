...
namespace ConsoleTest
{
    public class Report
    {
        public string StrData { get; set; } = "Hello World!";
        ...
        private void GenerateMainDocumentPart1Content(MainDocumentPart mainDocumentPart1)
        {
            ...
            Paragraph paragraph1 = new Paragraph() { RsidParagraphAddition = "00E00DE9", RsidRunAdditionDefault = "00FD6B64", ParagraphId = "18B7CEB5", TextId = "10975C56" };
            ...
            Run run1 = new Run() { RsidRunProperties = "00FD6B64" };

            RunProperties runProperties1 = new RunProperties();
            Shading shading1 = new Shading() { Val = ShadingPatternValues.Clear, Color = "auto", Fill = "FFC000" };
            Languages languages2 = new Languages() { Val = "en-US" };

            runProperties1.Append(shading1);
            ...
            Paragraph paragraph2 = new Paragraph() { RsidParagraphMarkRevision = "00FD6B64", RsidParagraphAddition = "00FD6B64", RsidRunAdditionDefault = "00FD6B64", ParagraphId = "19BE16A7", TextId = "13F65F22" };
            ...
            Run run2 = new Run() { RsidRunProperties = "00FD6B64" };
            ...
            SectionProperties sectionProperties1 = new SectionProperties() { RsidRPr = "00FD6B64", RsidR = "00FD6B64" };
        ...
        private void GenerateDocumentSettingsPart1Content(DocumentSettingsPart documentSettingsPart1)
        {
            ...
            RsidRoot rsidRoot1 = new RsidRoot() { Val = "00802F00" };
            Rsid rsid1 = new Rsid() { Val = "005B78AE" };
            Rsid rsid2 = new Rsid() { Val = "00802F00" };
            Rsid rsid3 = new Rsid() { Val = "00BA5836" };
            Rsid rsid4 = new Rsid() { Val = "00E00DE9" };
            Rsid rsid5 = new Rsid() { Val = "00FD6B64" };
            ...
            W14.DocumentId documentId1 = new W14.DocumentId() { Val = "21120403" };
            W15.ChartTrackingRefBased chartTrackingRefBased1 = new W15.ChartTrackingRefBased();
            W15.PersistentDocumentId persistentDocumentId1 = new W15.PersistentDocumentId() { Val = "{5DA5AD26-266D-4B57-B512-02536E0639B1}" };
        ...
        private void GenerateStyleDefinitionsPart1Content(StyleDefinitionsPart styleDefinitionsPart1)
        {
            ...
            Rsid rsid6 = new Rsid() { Val = "00BA5836" };
        ...
        private void SetPackageProperties(OpenXmlPackage document)
        {
            ...
            document.PackageProperties.Created = System.Xml.XmlConvert.ToDateTime("2019-02-20T18:14:00Z", System.Xml.XmlDateTimeSerializationMode.RoundtripKind);
            document.PackageProperties.Modified = System.Xml.XmlConvert.ToDateTime("2019-02-20T18:14:00Z", System.Xml.XmlDateTimeSerializationMode.RoundtripKind);
            document.PackageProperties.LastModifiedBy = "Павел Шмачилин";
        }

        #region Binary Data
        private string thumbnailPart1Data = "";
